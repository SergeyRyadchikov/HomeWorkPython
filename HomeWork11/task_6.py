...
with open ('HomeWork11/test_file.txt', 'rb') as t_f:
    test_file = t_f.read()
print(f"Кодировка файла: {chardet.detect(test_file)['encoding']}\n")

decode_file_utf8 = test_file.decode(chardet.detect(
    test_file)['encoding']).encode('utf-8').decode('utf-8')

print(f'Содержимое файла:\n{decode_file_utf8}')
decode_file_utf8_bytes = decode_file_utf8.encode()
print(f"Новая кодировка файла: {chardet.detect(decode_file_utf8_bytes)['encoding']}")
