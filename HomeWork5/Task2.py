...
def human_data(user_name):
    quantity_sweets = int(
        input(f"{user_name}, возьмите конфеты в количестве от 1 до 28: "))
    while quantity_sweets < 1 or quantity_sweets > 28:
        quantity_sweets = int(input(
            f"{user_name}, число указано неверно. Введите правильное число, пожалуйста: "))
